...
with open('pascal_voc_dataset.txt', 'r') as f:
...
# load the DNN model
model = cv2.dnn.readNet(model='/home/osman/PycharmProjects/ComputerVision/object-detection-in-keras/output/ssd300_vgg16_pascal-voc-2007/weight_model.h5',
